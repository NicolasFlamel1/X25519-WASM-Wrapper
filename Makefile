...
npm:
	...
	echo "try { module[\"exports\"] = require(\"@nicolasflamel/x25519-native\");} catch(error) {} if(Object.keys(module[\"exports\"])[\"length\"] === 0) { const x25519 = (typeof WebAssembly !== \"undefined\") ? require(\"./wasm.js\") : require(\"./asm.js\");" > "./index.js"
