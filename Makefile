...
npm:
	...
	echo "try { module[\"exports\"] = require(\"@nicolasflamel/x25519-native\"); return;} catch(error) {} const x25519 = (typeof WebAssembly !== \"undefined\") ? require(\"./wasm.js\") : require(\"./asm.js\");" > "./index.js"
