...
npm:
	...
	echo "\"use strict\"; try { module[\"exports\"] = require(\"@nicolasflamel/x25519-react\");} catch(error) { try { module[\"exports\"] = require(\"@nicolasflamel/x25519-native\");} catch(error) { const x25519 = (typeof WebAssembly !== \"undefined\") ? require(\"./wasm.js\") : require(\"./asm.js\");" > "./index.js"
